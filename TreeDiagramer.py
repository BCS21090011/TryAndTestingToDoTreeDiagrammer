...
Methods in TreeDiagramer:
    ...
    OneHotMapping:
        ...
        Will apply OneHotMapping for the column you gave to the Dataset if all the values in the column is not
        numeric. Will store the encoded column names in OneHotDataVal.
    ...
    Predict:
        ...
        Will use the inputs to predict. This part is also magic for me and I ain't gonna explain too much here. The
        inputs will only take 2d list. It SHOULD return the predicted value(s?).
